...
def annotationCapteurChoquet(valeurTemperature, valeurLuminosite, valeurCo2, valeurHumidite):
    annotationRetour = 0
    ...
    if(valeurHumidite <= 3 and valeurLuminosite >= 4):
        poidsTemperature = 0.3
        poidsLuminosite = 0.1
        poidsCo2 = 0.4
        poidsHumidite = 0.2
    elseif(valeurTemperature <= 3 and valeurHumidite >= 4 and valeurLuminosite  >= 4):
        poidsTemperature = 0.4
        poidsLuminosite = 0.1
        poidsCo2 = 0.4
        poidsHumidite = 0.1
    elseif(valeurTemperature >= 4 and valeurHumidite >= 4 and valeurLuminosite  <= 3):
        poidsTemperature = 0.2
        poidsLuminosite = 0.3
        poidsCo2 = 0.4
        poidsHumidite = 0.1
    else:
